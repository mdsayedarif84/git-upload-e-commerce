                    ...
                    <div class="product-slider owl-carousel owl-theme">
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="{{ route('product-details') }}">Fur coat with very but very very long name</a></h3>
                                    <p class="price">
                                        <del></del>$143.00
                                    </p>
                                </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="{{ route('product-details') }}">White Blouse Armani</a></h3>
                                    <p class="price">
                                        <del>$280</del>$143.00
                                    </p>
                                </div>
                            ...
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        ...
                                        <div class="back"><a href="{{ route('product-details') }}l"><img src="{{ asset('/') }}/front-end/imgs/product3_2.jpg" alt="" class="img-fluid"></a></div>
                                    </div>
                                </div><a href="{{ route('product-details') }}" class="invisible"><img src="{{ asset('/') }}/front-end/imgs/product3.jpg" alt="" class="img-fluid"></a>
                                <div class="text">
                                    <h3><a href="{{ route('product-details') }}">Black Blouse Versace</a></h3>
                                    <p class="price">
                                        <del></del>$143.00
                                    </p>
                                </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="{{ route('product-details') }}">White Blouse Versace</a></h3>
                                    <p class="price">
                                        <del></del>$143.00
                                    </p>
                                </div>
                        ...
                        <div class="item">
                            <div class="product">
                                ...
                                <div class="text">
                                    <h3><a href="{{ route('product-details') }}">Fur coat</a></h3>
                                    <p class="price">
                                        <del></del>$143.00
                                    </p>
                                </div>
                        ...
                        <div class="item">
                            <div class="product">
                                <div class="flip-container">
                                    <div class="flipper">
                                        <div class="front"><a href="{{ route('product-details') }}"><img src="img/product3.jpg" alt="" class="img-fluid"></a></div>
                                        <div class="back"><a href="{{ route('product-details') }}"><img src="img/product3_2.jpg" alt="" class="img-fluid"></a></div>
                                    </div>
                                </div><a href="{{ route('product-details') }}" class="invisible"><img src="img/product3.jpg" alt="" class="img-fluid"></a>
                                <div class="text">
                                    <h3><a href="{{ route('product-details') }}">Black Blouse Versace</a></h3>
                                    <p class="price">
                                        <del></del>$143.00
                ...
                <div class="col-md-12">
                    <div class="box slideshow">
                        ...
                        <div id="get-inspired" class="owl-carousel owl-theme">
                            <div class="item"><a href="#"><img src="{{ asset('/') }}/front-end/imgs/getinspired1.jpg" alt="Get inspired" class="img-fluid"></a></div>
