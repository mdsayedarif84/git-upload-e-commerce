                    ...
                    <div id="checkout" class="col-lg-9">
                        <div class="box">
                            <form method="get" action="checkout2.html">
                                ...
                                <div class="box-footer d-flex justify-content-between"><a href="{{ route('shopping-cart') }}" class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i>Back to Basket</a>
