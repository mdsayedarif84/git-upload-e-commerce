                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="product">
                                ...
                                <div class="text">
                                    ...
                                    <p class="buttons"><a href="{{ route('product-details') }}" class="btn btn-outline-secondary">View detail</a><a href="{{ route('shopping-cart') }}" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Add to cart</a></p>
                                </div>
                                <!-- /.text-->
                            </div>
                            <!-- /.product            -->
