                            ...
                            <form method="post" action="checkout1.html">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td><a href="#"><img src="{{ asset('/') }}/front-end/imgs/detailsquare.jpg" alt="White Blouse Armani"></a></td>
                                        ...
                                        <tr>
                                            <td><a href="#"><img src="{{ asset('/') }}/front-end/imgs/basketsquare.jpg" alt="Black Blouse Armani"></a></td>
                                ...
                                <div class="box-footer d-flex justify-content-between flex-column flex-lg-row">
                                    <div class="left"><a href="{{ route('product-details') }}" class="btn btn-outline-secondary"><i class="fa fa-chevron-left"></i> Continue shopping</a></div>
                                    <div class="right">
                                        <button class="btn btn-outline-secondary"><i class="fa fa-refresh"></i> Update cart</button>
                                        <button type="text" class="btn btn-outline-secondary"><a href="{{ route('checkout') }}" >Proceed to checkout</a> <i class="fa fa-chevron-right"></i></button>
                                    </div>
                                </div>
                            </form>
                        </div>
